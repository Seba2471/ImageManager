<template>
  <div>
    <v-row class="wrapper">
      ...
      <v-col cols="1" offset="2" offset-xl="3" offset-lg="2" offset-md="1" class="d-flex align-center">
        <v-row>
      ...
      <v-col cols="2" offset="1" xl="1" offset-xl="1" lg="1" offset-lg="2" offset-md="2" class="d-flex justify-end">
